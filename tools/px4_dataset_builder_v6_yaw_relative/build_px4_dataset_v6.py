#!/usr/bin/env python3
"""
PX4 Phase 1 dataset builder, v6 yaw-relative closed-loop.
...
v6 keeps the closed-loop PX4 position/velocity/yaw offboard setpoint contract
and adds the logged yaw offset from v15 yaw-relative collection.
...
def make_output_dir(config: dict[str, Any], output_root: str | None) -> Path:
    ...
    name = config.get("dataset_name", "px4_phase1_closed_loop_yawrel_dynamics_dataset_v6")
...
def main() -> None:
    ...
    write_json(
        ...
        {
            "builder_version": "v6_yaw_relative",
