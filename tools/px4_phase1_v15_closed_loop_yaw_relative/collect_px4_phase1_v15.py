#!/usr/bin/env python3
"""
PX4 Gazebo Phase 1 data collector, v15 closed-loop yaw-relative.
...
async def main_async(args: argparse.Namespace) -> None:
    ...
    run_metadata = {
        "collector_version": "v15_closed_loop_yaw_relative",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="PX4 Gazebo Phase 1 data collector v15 closed-loop yaw-relative.")
